...
__all__ = ['device', 'generate_example_inputs', 'ctc_loss_pytorch', 'interleave_blanks', 'prepare_inputs',
           'ctc_logz_fwd', 'ctc_loss_basic', 'semiring', 'neginf', 'Log', 'ctc_fwd_bwd', 'masked_grad', 'CTCLogz',
           'ctc_loss_py', 'ctc_loss_cupy', 'cupy_funcs', 'max_grad', 'CTCLogzViterbi', 'Max', 'viterbi_alignments',
           'soft_alignments', 'CTCLogzDirect', 'ctc_loss_direct_cupy', 'Prob']
...
class CTCLogz(torch.autograd.Function):
    @staticmethod
...
def ctc_loss_py(logits, targets, input_lengths, target_lengths):
    logz = CTCLogz.apply(*prepare_inputs(logits.log_softmax(2), targets, input_lengths, target_lengths), _ctc_fwd_bwd_py)
    return - (logz / target_lengths).mean()
