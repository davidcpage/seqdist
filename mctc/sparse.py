...
__all__ = ['device', 'Mv_scan_py', 'transpose', 'logZ_py', 'ctc_loss_py', 'Mv_scan_cupy', 'logZ', 'cupy_funcs',
           'ctc_loss']
...
def logZ_py(Ms, idx, v0, vT, S:semiring):
    return _LogZ.apply(Ms, idx, v0, vT, S, Mv_scan_py)
...
def logZ(Ms, idx, v0, vT, S:semiring):
    return _LogZ.apply(Ms, idx, v0, vT, S, Mv_scan_cupy)
